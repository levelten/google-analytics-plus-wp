...
final class GAPWP_Frontend_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo "\n<!-- BEGIN GAPWP v" . GAPWP_CURRENT_VERSION . " Widget - https://deconf.com/google-analytics-dashboard-wordpress/ -->\n";
...
<?php
		if ( 1 == $instance['give_credits'] ) :
			?>
<div style="text-align: right; width: 100%; font-size: 0.8em; clear: both; margin-right: 5px;"><?php _e( 'generated by', 'google-analytics-plus-wp' ); ?> <a href="https://deconf.com/google-analytics-dashboard-wordpress/?utm_source=gapwp_report&utm_medium=link&utm_content=front_widget&utm_campaign=gapwp" rel="nofollow" style="text-decoration: none; font-size: 1em;">GAPWP</a>&nbsp;
</div>
