...
final class GAPWP_Settings {
	...
	private static function update_options( $who, $validation_error = 0 ) {
		...
		if ( isset( $_POST['options']['gapwp_hidden'] ) && isset( $_POST['options'] ) && ( isset( $_POST['gapwp_security'] ) && wp_verify_nonce( $_POST['gapwp_security'], 'gapwp_form' ) ) && !$validation_error && 'Reset' != $who ) {
			...
			$gapwp->config->options = $options;
			$gapwp->config->set_plugin_options( $network_settings );
		}
		return $options;
	}
	...
	private static function navigation_tabs( $tabs ) {
		...
		foreach ( $tabs as $tab => $name ) {
			echo "<a class='nav-tab' id='tab-$tab' href='#top#gapwp-$tab'>$name</a>";
		}
		echo '</h2>';
	}
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_with_gtag]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_with_gtag" <?php checked( $options['ga_with_gtag'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_with_gtag">
						...
						<div id="gapwp-events">
							<table class="gapwp-settings-options">
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_event_tracking]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_event_tracking" <?php checked( $options['ga_event_tracking'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_event_tracking">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_aff_tracking]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_aff_tracking" <?php checked( $options['ga_aff_tracking'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_aff_tracking">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_hash_tracking]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_hash_tracking" <?php checked( $options['ga_hash_tracking'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_hash_tracking">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_formsubmit_tracking]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_formsubmit_tracking" <?php checked( $options['ga_formsubmit_tracking'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_formsubmit_tracking">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_pagescrolldepth_tracking]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_pagescrolldepth_tracking" <?php checked( $options['ga_pagescrolldepth_tracking'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_pagescrolldepth_tracking">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									...
									<td>
										<select id="tm_author_var" name="options[tm_author_var]">
											<option value="1" <?php selected( $options['tm_author_var'], 1 ); ?>>gapwpAuthor</option>
								...
								<tr>
									...
									<td>
										<select id="tm_pubyear_var" name="options[tm_pubyear_var]">
											<option value="1" <?php selected( $options['tm_pubyear_var'], 1 ); ?>>gapwpPublicationYear</option>
								...
								<tr>
									...
									<td>
										<select id="tm_pubyearmonth_var" name="options[tm_pubyearmonth_var]">
											<option value="1" <?php selected( $options['tm_pubyearmonth_var'], 1 ); ?>>gapwpPublicationYearMonth</option>
								...
								<tr>
									...
									<td>
										<select id="tm_category_var" name="options[tm_category_var]">
											<option value="1" <?php selected( $options['tm_category_var'], 1 ); ?>>gapwpCategory</option>
								...
								<tr>
									...
									<td>
										<select id="tm_user_var" name="options[tm_user_var]">
											<option value="1" <?php selected( $options['tm_user_var'], 1 ); ?>>gapwpUser</option>
								...
								<tr>
									...
									<td>
										<select id="tm_tag_var" name="options[tm_tag_var]">
											<option value="1" <?php selected( $options['tm_tag_var'], 1 ); ?>>gapwpTag</option>
						...
						<div id="gapwp-advanced">
							<table class="gapwp-settings-options">
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_anonymize_ip]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_anonymize_ip" <?php checked( $options['ga_anonymize_ip'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_anonymize_ip">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_optout]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_optout" <?php checked( $options['ga_optout'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_optout">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_dnt_optout]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_dnt_optout" <?php checked( $options['ga_dnt_optout'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_dnt_optout">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_remarketing]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_remarketing" <?php checked( $options['ga_remarketing'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_remarketing">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_event_bouncerate]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_event_bouncerate" <?php checked( $options['ga_event_bouncerate'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_event_bouncerate">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_enhanced_links]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_enhanced_links" <?php checked( $options['ga_enhanced_links'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_enhanced_links">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_event_precision]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_event_precision" <?php checked( $options['ga_event_precision'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_event_precision">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_force_ssl]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_force_ssl" <?php checked( $options['ga_force_ssl'] || $options['ga_with_gtag'], 1 ); ?>  <?php disabled( $options['ga_with_gtag'], true );?>>
											<label class="gapwp-settings-switchoo-label" for="ga_force_ssl">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[ga_crossdomain_tracking]" value="1" class="gapwp-settings-switchoo-checkbox" id="ga_crossdomain_tracking" <?php checked( $options['ga_crossdomain_tracking'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="ga_crossdomain_tracking">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
						...
						<div id="gapwp-integration">
							<table class="gapwp-settings-options">
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[amp_tracking_analytics]" value="1" class="gapwp-settings-switchoo-checkbox" id="amp_tracking_analytics" <?php checked( $options['amp_tracking_analytics'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="amp_tracking_analytics">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[amp_tracking_clientidapi]" value="1" class="gapwp-settings-switchoo-checkbox" id="amp_tracking_clientidapi" <?php checked( $options['amp_tracking_clientidapi'] && !$options['ga_with_gtag'], 1 ); ?> <?php disabled( $options['ga_with_gtag'], true );?>>
											<label class="gapwp-settings-switchoo-label" for="amp_tracking_clientidapi">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[optimize_tracking]" value="1" class="gapwp-settings-switchoo-checkbox" id="optimize_tracking" <?php checked( $options['optimize_tracking'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="optimize_tracking">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[optimize_pagehiding]" value="1" class="gapwp-settings-switchoo-checkbox" id="optimize_pagehiding" <?php checked( $options['optimize_pagehiding'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="optimize_pagehiding">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
						...
						<div id="gapwp-tmadvanced">
							<table class="gapwp-settings-options">
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[tm_optout]" value="1" class="gapwp-settings-switchoo-checkbox" id="tm_optout" <?php checked( $options['tm_optout'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="tm_optout">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[tm_dnt_optout]" value="1" class="gapwp-settings-switchoo-checkbox" id="tm_dnt_optout" <?php checked( $options['tm_dnt_optout'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="tm_dnt_optout">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
						...
						<div id="gapwp-tmintegration">
							<table class="gapwp-settings-options">
								...
								<tr>
									<td colspan="2" class="gapwp-settings-title">
										<div class="button-primary gapwp-settings-switchoo">
											<input type="checkbox" name="options[amp_tracking_tagmanager]" value="1" class="gapwp-settings-switchoo-checkbox" id="amp_tracking_tagmanager" <?php checked( $options['amp_tracking_tagmanager'], 1 ); ?>>
											<label class="gapwp-settings-switchoo-label" for="amp_tracking_tagmanager">
												<div class="gapwp-settings-switchoo-inner"></div>
												<div class="gapwp-settings-switchoo-switch"></div>
											</label>
										</div>
...
<div id="poststuff" class="gapwp">
		...
		<div id="post-body-content">
			<div class="settings-wrapper">
				<div class="inside">
						...
						<?php self::navigation_tabs( $tabs ); ?>
						<div id="gapwp-errors">
						<table class="gapwp-settings-logdata">
							<tr>
								<td>
							...
							<tr>
								<td>
									...
									<pre class="gapwp-settings-logdata"><?php echo '<span>' . __("Count: ", 'google-analytics-plus-wp') . '</span>' . (int)$errors_count;?></pre>
									...
									<pre class="gapwp-settings-logdata"><?php echo '<span>' . __("Last Error: ", 'google-analytics-plus-wp') . '</span>' . "\n" . $errors;?></pre>
									<pre class="gapwp-settings-logdata"><?php echo '<span>' . __("GAPI Error: ", 'google-analytics-plus-wp') . '</span>'; echo "\n" . esc_html( print_r( GAPWP_Tools::get_cache( 'gapi_errors' ), true ) ) ?></pre>
									<br />
									<hr>
								</td>
							</tr>
					...
					<div id="gapwp-config">
						<table class="gapwp-settings-options">
							...
							<tr>
								<td>
									<pre class="gapwp-settings-logdata"><?php echo esc_html(print_r($anonim, true));?></pre>
									<br />
									<hr>
								</td>
							</tr>
					...
					<div id="gapwp-sysinfo">
						<table class="gapwp-settings-options">
							...
							<tr>
								<td>
									<pre class="gapwp-settings-logdata"><?php echo esc_html(GAPWP_Tools::system_info());?></pre>
									<br />
									<hr>
								</td>
							</tr>
	...
	public static function general_settings() {
		...
		if ( isset( $_POST['gapwp_access_code'] ) ) {
			if ( 1 == ! stripos( 'x' . $_POST['gapwp_access_code'], 'UA-', 1 ) && $_POST['gapwp_access_code'] != get_option( 'gapwp_redeemed_code' ) ) {
				try {
					$gapwp_access_code = $_POST['gapwp_access_code'];
					...
					$gapwp->config->set_plugin_options();
					$options = self::update_options( 'general' );
					$message = "<div class='updated' id='gapwp-autodismiss'><p>" . __( "Plugin authorization succeeded.", 'google-analytics-plus-wp' ) . "</p></div>";
					if ( $gapwp->config->options['token'] && $gapwp->gapi_controller->client->getAccessToken() ) {
						$profiles = $gapwp->gapi_controller->refresh_profiles();
						if ( is_array ( $profiles ) && ! empty( $profiles ) ) {
							$gapwp->config->options['ga_profiles_list'] = $profiles;
							if ( ! $gapwp->config->options['tableid_jail'] ) {
								$profile = GAPWP_Tools::guess_default_domain( $profiles );
								$gapwp->config->options['tableid_jail'] = $profile;
							}
							$gapwp->config->set_plugin_options();
							$options = self::update_options( 'general' );
						}
					...
					$timeout = $gapwp->gapi_controller->get_timeouts( 'midnight' );
				...
				if ( 1 == stripos( 'x' . $_POST['gapwp_access_code'], 'UA-', 1 ) ) {
					$message = "<div class='error' id='gapwp-autodismiss'><p>" . __( "The access code is <strong>not</strong> your <strong>Tracking ID</strong> (UA-XXXXX-X) <strong>nor</strong> your <strong>email address</strong>!", 'google-analytics-plus-wp' ) . ".</p></div>";
				} else {
					$message = "<div class='error' id='gapwp-autodismiss'><p>" . __( "You can only use the access code <strong>once</strong>, please generate a <strong>new access</strong> code following the instructions!", 'google-analytics-plus-wp' ) . ".</p></div>";
				}
			}
		}
		if ( isset( $_POST['Clear'] ) ) {
			if ( isset( $_POST['gapwp_security'] ) && wp_verify_nonce( $_POST['gapwp_security'], 'gapwp_form' ) ) {
				...
				$message = "<div class='updated' id='gapwp-autodismiss'><p>" . __( "Cleared Cache.", 'google-analytics-plus-wp' ) . "</p></div>";
			} else {
				$message = "<div class='error' id='gapwp-autodismiss'><p>" . __( "Cheating Huh?", 'google-analytics-plus-wp' ) . "</p></div>";
			}
		}
		...
		if ( isset( $_POST['Reset_Err'] ) ) {
			if ( isset( $_POST['gapwp_security'] ) && wp_verify_nonce( $_POST['gapwp_security'], 'gapwp_form' ) ) {
				...
				if ( GAPWP_Tools::get_cache( 'gapi_errors' ) || GAPWP_Tools::get_cache( 'last_error' ) ) {
					...
					$url = GAPWP_ENDPOINT_URL . 'gapwp-report.php';
					/* @formatter:off */
				...
				$message = "<div class='updated' id='gapwp-autodismiss'><p>" . __( "All errors reseted.", 'google-analytics-plus-wp' ) . "</p></div>";
			} else {
				$message = "<div class='error' id='gapwp-autodismiss'><p>" . __( "Cheating Huh?", 'google-analytics-plus-wp' ) . "</p></div>";
			}
		}
		...
		if ( isset( $_POST['Hide'] ) ) {
			if ( isset( $_POST['gapwp_security'] ) && wp_verify_nonce( $_POST['gapwp_security'], 'gapwp_form' ) ) {
				$message = "<div class='updated' id='gapwp-action'><p>" . __( "All other domains/properties were removed.", 'google-analytics-plus-wp' ) . "</p></div>";
				$lock_profile = GAPWP_Tools::get_selected_profile( $gapwp->config->options['ga_profiles_list'], $gapwp->config->options['tableid_jail'] );
				$gapwp->config->options['ga_profiles_list'] = array( $lock_profile );
				$options = self::update_options( 'general' );
			} else {
				$message = "<div class='error' id='gapwp-autodismiss'><p>" . __( "Cheating Huh?", 'google-analytics-plus-wp' ) . "</p></div>";
			}
					...
					<div id="poststuff" class="gapwp">
						<div id="post-body" class="metabox-holder columns-2">
							<div id="post-body-content">
								<div class="settings-wrapper">
									<div class="inside">
										<?php if ( $gapwp->gapi_controller->gapi_errors_handler() || GAPWP_Tools::get_cache( 'last_error' ) ) : ?>
													<?php $message = sprintf( '<div class="error"><p>%s</p></div>', sprintf( __( 'Something went wrong, check %1$s or %2$s.', 'google-analytics-plus-wp' ), sprintf( '<a href="%1$s">%2$s</a>', menu_page_url( 'gapwp_errors_debugging', false ), __( 'Errors & Debug', 'google-analytics-plus-wp' ) ), sprintf( '<a href="%1$s">%2$s</a>', menu_page_url( 'gapwp_settings', false ), __( 'authorize the plugin', 'google-analytics-plus-wp' ) ) ) );?>
										<?php endif;?>
										<?php if ( isset( $_POST['Authorize'] ) ) : ?>
											<?php GAPWP_Tools::clear_cache(); ?>
											<?php $gapwp->gapi_controller->token_request(); ?>
											<div class="updated">
	...
	public static function general_settings_network() {
		...
		if ( isset( $_POST['gapwp_access_code'] ) ) {
			if ( 1 == ! stripos( 'x' . $_POST['gapwp_access_code'], 'UA-', 1 ) && $_POST['gapwp_access_code'] != get_option( 'gapwp_redeemed_code' ) ) {
				try {
					...
					$gapwp->config->options['token'] = $gapwp->gapi_controller->client->getAccessToken();
					$gapwp->config->options['automatic_updates_minorversion'] = 1;
					$gapwp->config->set_plugin_options( true );
					$options = self::update_options( 'network' );
					$message = "<div class='updated' id='gapwp-action'><p>" . __( "Plugin authorization succeeded.", 'google-analytics-plus-wp' ) . "</p></div>";
					...
					if ( $gapwp->config->options['token'] && $gapwp->gapi_controller->client->getAccessToken() ) {
						...
						if ( is_array ( $profiles ) && ! empty( $profiles ) ) {
							$gapwp->config->options['ga_profiles_list'] = $profiles;
							if ( isset( $gapwp->config->options['tableid_jail'] ) && ! $gapwp->config->options['tableid_jail'] ) {
								$profile = GAPWP_Tools::guess_default_domain( $profiles );
								$gapwp->config->options['tableid_jail'] = $profile;
							}
							$gapwp->config->set_plugin_options( true );
				...
				if ( 1 == stripos( 'x' . $_POST['gapwp_access_code'], 'UA-', 1 ) ) {
					...
					$message = "<div class='error' id='gapwp-autodismiss'><p>" . __( "You can only use the access code <strong>once</strong>, please generate a <strong>new access code</strong> using the red link", 'google-analytics-plus-wp' ) . "!</p></div>";
				}
			}
		}
		if ( isset( $_POST['Refresh'] ) ) {
			if ( isset( $_POST['gapwp_security'] ) && wp_verify_nonce( $_POST['gapwp_security'], 'gapwp_form' ) ) {
				$gapwp->config->options['ga_profiles_list'] = array();
				$message = "<div class='updated' id='gapwp-autodismiss'><p>" . __( "Properties refreshed.", 'google-analytics-plus-wp' ) . "</p></div>";
				$options = self::update_options( 'network' );
				if ( $gapwp->config->options['token'] && $gapwp->gapi_controller->client->getAccessToken() ) {
					if ( ! empty( $gapwp->config->options['ga_profiles_list'] ) ) {
						$profiles = $gapwp->config->options['ga_profiles_list'];
					} else {
						$profiles = $gapwp->gapi_controller->refresh_profiles();
					}
					if ( $profiles ) {
		...
		if ( isset( $_POST['options']['gapwp_hidden'] ) && ! isset( $_POST['Clear'] ) && ! isset( $_POST['Reset'] ) && ! isset( $_POST['Refresh'] ) ) {
			$message = "<div class='updated' id='gapwp-autodismiss'><p>" . __( "Settings saved.", 'google-analytics-plus-wp' ) . "</p></div>";
			if ( ! ( isset( $_POST['gapwp_security'] ) && wp_verify_nonce( $_POST['gapwp_security'], 'gapwp_form' ) ) ) {
				$message = "<div class='error' id='gapwp-autodismiss'><p>" . __( "Cheating Huh?", 'google-analytics-plus-wp' ) . "</p></div>";
			}
		...
		if ( isset( $_POST['Hide'] ) ) {
			if ( isset( $_POST['gapwp_security'] ) && wp_verify_nonce( $_POST['gapwp_security'], 'gapwp_form' ) ) {
				$message = "<div class='updated' id='gapwp-autodismiss'><p>" . __( "All other domains/properties were removed.", 'google-analytics-plus-wp' ) . "</p></div>";
				$lock_profile = GAPWP_Tools::get_selected_profile( $gapwp->config->options['ga_profiles_list'], $gapwp->config->options['tableid_jail'] );
				$gapwp->config->options['ga_profiles_list'] = array( $lock_profile );
				$options = self::update_options( 'network' );
			} else {
